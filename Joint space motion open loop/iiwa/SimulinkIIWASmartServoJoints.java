...
public class SimulinkIIWASmartServoJoints extends RoboticsAPIApplication
{
    private LBR _lbr;
    ...
    {
        SimulinkIIWASmartServoJoints app = new SimulinkIIWASmartServoJoints();
        app.runApplication();
    }
    ...
    public class UDPServer implements Runnable{
    	...
    	public void run()
    	{
    			...
    			else
    			{
   				...
   				SimulinkIIWASmartServoJoints.loopFlag=false; //Turn off main loop 	
