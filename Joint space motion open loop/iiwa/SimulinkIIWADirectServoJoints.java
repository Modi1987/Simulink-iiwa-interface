 ...
 * This server works together with the Simulink example: (smartDirectServoJoints.slx)
 * 
 ...
 *    turn off.
 * 3- Start the Simulink example (smartDirectServoJoints.slx)
...
public class SimulinkIIWADirectServoJoints extends RoboticsAPIApplication
{
    private LBR _lbr;
    ...
    {
        SimulinkIIWADirectServoJoints app = new SimulinkIIWADirectServoJoints();
        app.runApplication();
    }
    	...
    	public void run()
    	{
    		System.out.println("Program will terminate if comuncation is not established in 10 seconds");
    			...
    			else
    			{
   				...
   				SimulinkIIWADirectServoJoints.loopFlag=false; //Turn off main loop 	
